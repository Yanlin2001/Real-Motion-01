...
class SRModel_fft(BaseModel):
    ...
    def init_training_settings(self):
        ...
        if self.cri_pix is None and self.cri_perceptual is None and self.cri_fft is None:
            raise ValueError('Both pixel and perceptual and fft losses are None.')
    ...
    def optimize_parameters(self, current_iter):
        ...
        if self.undersampled == True:
            ...
            for sample_index in range(batch_size):
                ...
                under_image = transforms.ToPILImage()(self.raw_output[sample_index].cpu())
                fill_image = transforms.ToPILImage()(self.output[sample_index].cpu())
                ...
                fill_image.save(save_path)
                under_image.save(save_path2)
